...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.CharField(
                        help_text="The page description that will appear under the title.",
                        max_length=255,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "category",
                    models.ForeignKey(
                        related_name="+", verbose_name="Category", to="puput.Category", on_delete=models.CASCADE
                    ),
                ),
            ],
            options={},
            ...
            fields=[
                ...
                (
                    ...
                    modelcluster.fields.ParentalKey(
                        related_name="related_entrypage_from", verbose_name="Entry", to="puput.EntryPage"
                    ),
                ),
                (
                    "entrypage_to",
                    modelcluster.fields.ParentalKey(
                        related_name="related_entrypage_to", verbose_name="Entry", to="puput.EntryPage"
                    ),
                ),
            ],
            options={},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tag",
                    models.ForeignKey(
                        related_name="puput_tagentrypage_items", to="taggit.Tag", on_delete=models.CASCADE
                    ),
                ),
            ],
        ...
        migrations.CreateModel(name="Tag", fields=[], options={"proxy": True}, bases=("taggit.tag",)),
    ]
